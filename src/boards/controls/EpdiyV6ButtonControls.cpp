...
bool EpdiyV6ButtonControls::did_wake_from_deep_sleep()
{
...
UIAction EpdiyV6ButtonControls::get_deep_sleep_action()
{
  if (active_level == 0)
  {
...
uint8_t EpdiyV6ButtonControls::pca9555_read_input(i2c_port_t i2c_port, int high_port)
{
  esp_err_t err;
  uint8_t r_data[1];
